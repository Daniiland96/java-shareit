...
public class UserControllerTest {
    ...
    @BeforeEach
    void setUp() {
        userDto = new UserDto(userId, "Test", "Test@yandex.ru");
    }
    ...
    void update() throws Exception {
        UpdateUserRequest request = new UpdateUserRequest(userDto.getName(), userDto.getEmail());
        when(userService.update(userDto.getId(), request)).thenReturn(userDto);
