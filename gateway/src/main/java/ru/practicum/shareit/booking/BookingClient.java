...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> create(Long bookerId, CreateBookingDto bookingDto) {
    ...
    public ResponseEntity<Object> findAllBookingsOfBooker(Long userId, BookingState state) {
        Map<String, Object> parameters = Map.of("state", state);
        return get("", userId, parameters);
    }

    public ResponseEntity<Object> findAllBookingsOfOwner(Long ownerId, BookingState state) {
        Map<String, Object> parameters = Map.of("state", state);
